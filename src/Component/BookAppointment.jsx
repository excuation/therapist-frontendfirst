...
const BookAppointment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedDate <= today) {
      alert("Appointments for today or past dates are not allowed.");
      return;
    }
  ...
  return (
    <div style={{ backgroundColor: '#121212', color: '#fff', padding: '2rem', borderRadius: '10px', width: '100%', margin: 'auto', boxShadow: '0 0px 16px rgba(0, 0, 0, 0.3)' }}>
